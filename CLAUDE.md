...
- 2026-09-01: Accepted T1 contract doc fix (`66323ee`): result artifacts are captured from Codex's final message (`--output-last-message`); direct edits are overwritten. Checkpoint: `.claude/checkpoints/2026-09-01-contract-result-capture-doc.md`.
